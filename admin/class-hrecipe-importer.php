...
//			"fresh",
		...
		usort( $this->ingrd_attributes, function ( $a, $b ) {
	...
	function upload_form() {
        ...
        <form enctype="multipart/form-data" id="import-upload-form" method="post"
            ...
            <p>
                <label for="upload"><h3><?php _e( 'Select a recipe file from your computer:', $this->domain ); ?></h3>
                </label> (<?php printf( __( 'Maximum size: %s', $this->domain ), $size ); ?>)<br/>
            ...
            <ul>
                <li><input type="radio" name="post_status" value="draft" checked><?php _e( 'Drafts', $this->domain ); ?>
                </li>
                <li><input type="radio" name="post_status" value="publish"><?php _e( 'Published', $this->domain ); ?>
                </li>
                <li><input type="radio" name="post_status"
                           value="private"><?php _e( 'Private (only visible to Editors and Administrators)', $this->domain ); ?>
                </li>
				<?php
				if ( WP_DEBUG ) {
					?>
	...
	function map_category_form( $post_status, $recipes, $unknown ) {
        ...
        <form enctype="multipart/form-data" id="import-upload-form" method="post"
            ...
            Unknown categories were found in the imported file. Please indicate how each one should be created in the
            table below.
            <table>
	 ...
	 * @access private
	 *
	 * @param array $content Each index element is sub-array containing ['type'] and ['data']
	 *
	 * @return string HTML
	 **/

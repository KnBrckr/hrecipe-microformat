	...
	public function form( $instance ) {
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id( 'list_type' ) ); ?>">List Type</label>
            <select id="<?php echo esc_attr( $this->get_field_id( 'list_type' ) ); ?>"
                ...
                <option value="published" <?php if ( $list_type == "published" ): ?>selected<?php endif; ?>>Recently
                    Published
                </option>
                <option value="edited" <?php if ( $list_type == "edited" ): ?>selected<?php endif; ?>>Recently Edited
                </option>
            </select>
        </p>
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'num_recipes' ) ); ?>"
                   ...
                   value="<?php echo $instance['num_recipes']; ?>"
                   name="<?php echo esc_attr( $this->get_field_name( 'num_recipes' ) ); ?>"/>
        </p>
		<?php
	}
